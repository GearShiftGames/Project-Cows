...
namespace Project_Cows.Source.Application.Entity.Vehicle {
    class BestSuperVehicle {
        // Temporary class for the new vehicle implementation
        // ================
        ...
        // Methods
        public BestSuperVehicle(World world_, Texture2D texture_, EntityStruct entityStruct_) {
            ...
            //m_vehicleBody.SetPosition(entityStruct_.GetPosition());
